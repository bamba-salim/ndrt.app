...
function ListTpl ({component: Component, list = [], item_per_page = 10, emptyMessage = "La list est vide !", setList = null, pagination = true}) {
        ...
        const current_items = pagination ? list.slice(i_first_item, i_last_item) : list;
