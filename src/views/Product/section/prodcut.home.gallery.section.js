...
export function ProdcutHomeGallerySlider(){
    return (<div>
        <div id="carouselExampleFade" className="d-sm-none carousel slide carousel-fade p-0 m-0" data-bs-ride="carousel">
            <div className="carousel-inner">
                <div className="carousel-item image active">
                    <img src={image} className="d-block w-100" alt="..." />
                    <div className="image-overlay text-center">
                        <Link to='/login' className="Link" >1</Link>
                    </div>
                </div>
                <div className="carousel-item image">
                    <img src={image} className="d-block w-100" alt="..." />
                    <div className="image-overlay text-center">
                        <Link to='/login' className="Link" >2</Link>
                    </div>
                </div>
                <div className="carousel-item image">
                    <img src={image} className="d-block w-100" alt="..." />
                    <div className="image-overlay text-center">
                        <Link to='/login' className="Link" >3</Link>
                    </div>
                </div>
            </div>
